...
function(find_artifactory_package)
    ...
    set(CURL_COMMAND)
    list(APPEND CURL_COMMAND curl -k -u conan-user:XQlM?4KxtCPOp@0t -X POST -H "content-type: text/plain" --data @${PROJECT_BINARY_DIR}/aql.json https://lkeb-artifactory.lumc.nl:443/artifactory/api/search/aql)
