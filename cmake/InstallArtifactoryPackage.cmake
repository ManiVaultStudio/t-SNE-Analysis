...
macro(get_artifactory_package
	...
	if(is_combined_package)
		...
		execute_process(COMMAND cmake -E make_directory "${INSTALL_DIR}/${package_name}")
		execute_process(COMMAND cmake -E tar xvf "${CMAKE_SOURCE_DIR}/${package_name}.tgz" WORKING_DIRECTORY "${INSTALL_DIR}/${package_name}")
	else()
		file(REMOVE ${CMAKE_BINARY_DIR}/aql.json)
